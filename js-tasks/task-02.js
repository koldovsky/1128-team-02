...
function min(arr, toReturn) {
    return toReturn === "value" ? Math.min(...arr) : arr.indexOf(min(arr, "value"));
  }
...
function warnTheSheep(queue) {
    ...
    return position === queue.length - 1
      ...
      : "Oi! Sheep number " + (queue.length - 1 - position) + "! You are about to be eaten by a wolf!";
  }
...
function makeNegative(num) { //was last time
